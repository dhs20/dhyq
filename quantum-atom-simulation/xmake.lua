...
target("quantum_atom_simulation")
    set_kind("binary")
    add_files("app/**.cpp", "core/**.cpp", "data/**.cpp", "dynamics/**.cpp", "physics/**.cpp", "render/**.cpp", "spectroscopy/**.cpp", "ui/**.cpp", "validation/**.cpp")
...
target("quantum_atom_tests")
    set_kind("binary")
    set_group("tests")
    add_files("tests/**.cpp", "core/**.cpp", "data/**.cpp", "dynamics/**.cpp", "physics/**.cpp", "spectroscopy/**.cpp", "validation/**.cpp")
    add_includedirs("include")
