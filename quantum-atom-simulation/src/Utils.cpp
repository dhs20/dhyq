...
double Utils::entropyChange(double heatJoule, double temperatureKelvin) {
    if (temperatureKelvin <= 0.0) {
        return 0.0;
    }
    return heatJoule / temperatureKelvin;
}

double Utils::deBroglieWavelength(double mass, double velocity) {
