...
public:
    ...
    [[nodiscard]] std::vector<IsotopeRecord> isotopesForAtomicNumber(int atomicNumber) const override;
    [[nodiscard]] std::vector<TransitionRecord> referenceTransitions(int atomicNumber) const override;
    [[nodiscard]] std::vector<TransitionRecord> referenceTransitions(int atomicNumber, int chargeState) const override;
...
private:
    ...
    std::vector<IsotopeRecord> isotopes_;
